...
$strSQL = "SELECT productinfo.id_prodinfo,productdir.name,productinfo.title,productinfo.content FROM productinfo left join productdir on productinfo.id_proddir=productdir.id_proddir WHERE productinfo.dele='1' $str order by productinfo.id_prodinfo DESC" ;
