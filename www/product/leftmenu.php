...
<table width="180" border="0" align="center" cellpadding="3" cellspacing="3" class="txt">
  <tr>
	...
	?>
      <tr  height="28">
        <td align="left"  style="cursor:pointer;background:url(../inc/pics/bg2.gif) repeat-x left bottom;" ><strong>·</strong> <a href="javascript:void(0)"  <?php if($_GET[id1]==$arrnewsdir1[$i][id_proddir]){echo 'class="link_04_1"';}else{echo 'class="link_04"';} ?>  onClick="ChangeTab(<?php echo $i;?>);"><?php echo $arrnewsdir1[$i][name];?></a></td>
      </tr>
