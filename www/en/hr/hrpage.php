<?php
require "../../inc/en_hrpage_core.php";
?>
    ...
    <td width="773" valign="top"><table width="733" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:19px;">
        <tr>
          <td width="733" style="background:url(/inc/pics/bg1.gif) repeat-x left bottom;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" align="right" style="color:#999999"><img src="/inc/pics/arr6.gif" width="9" height="9" align="absmiddle" />&nbsp;Now：<a href="/" class="agray">Home</a> - <a href="/hr/hr.php" class="agray">Human Resources</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><table width="733" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="673" align="left" background="/inc/pics/title_bg_center.jpg" style="color:#000000; font-size:14px; font-weight:bold"><?=$onenews[title];?></td>
        ...
        <tr>
          <td align="center" valign="middle"><table width="95%" border="0" align="center">
            <tr>
              <td align="left"  style="color:#494949; line-height:25px;"  height="25"><?=$onenews[content];?></td>
            </tr>
          </table></td>
        </tr>
      </table></td>
