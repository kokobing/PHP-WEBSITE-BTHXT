    ...
    <td width="230" align="left" valign="top"><table width="230" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        <td align="center" ><table width="100%" border="0" cellpadding="0" cellspacing="0" >
            <tr>
              <td height="25" style="background:url(inc/pics/bg6.gif) repeat-x left bottom;" valign="top"><span id="tag_2" class="tagdef" onclick="tag('1');"><strong>关于我们</strong></span> </td>
            </tr>
            <tr>
              <td><table width="100%" cellpadding="0" cellspacing="0" id="tagCon_2">
                  ...
                  <tr>
                    <td height="25" align="right">&nbsp;&nbsp;&nbsp;<img src="inc/pics/arr7.gif" width="7" height="7" align="absmiddle" /> <a href="/about/about.php?pageid=1">查看详细》</a>&nbsp;&nbsp;</td>
                  </tr>
              </table></td>
            </tr>
            <tr>
...
<img src="inc/pics/video.gif" width="230" height="35" />
        </td>
      </tr>
      <tr>
        <td height="107" valign="top" style="border:1px solid #DDDDDD; border-top:0px none; background:url(inc/pics/v_bg.jpg) repeat-x left bottom;">
        <div id="home_partner"> 
<ul>
...
<td width="480" height="24" align="center"><table width="450" border="0" cellspacing="0" cellpadding="0">
        <tr>
                      <td width="243" align="left"><img src="inc/pics/m_bt1.gif" width="120" height="24" /></td>
                <td width="243" align="right" valign="bottom"><a href="/news/news.php"><img src="inc/pics/more2.gif" alt="更多新闻" width="51" height="14" border="0" style="margin-bottom:7px;" /></a></td>
                    </tr>
                  </table></td>
        </tr>
    ...
    <td height="25"><table width="450" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td  align="left" width="360" style="background:url(inc/pics/bg5.gif) repeat-x left bottom;"><img src="inc/pics/arr2.gif" width="3" height="5" align="absmiddle" />&nbsp;&nbsp;<a href="/news/newspage.php?newsid=<?=$arrallnews[$i][id_newsinfo];?>&ndir=<?=$arrallnews[$i][id_newsdir];?>"><?=cutstr($arrallnews[$i][title],50,1)?></a></td>
        ...
        <? }?>
            ...
            <table width="450" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
              <tr>
                <td width="480" height="24" align="center" ><table width="450" border="0" cellspacing="0" cellpadding="0">
                <tr>
                      <td width="243" align="left"><img src="inc/pics/m_bt2.gif" width="120" height="24" /></td>
                  <td width="243" align="right" valign="bottom"><a href="/product/product.php"><img src="inc/pics/more2.gif" alt="更多产品" width="51" height="14" border="0" style="margin-bottom:7px;" /></a></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
        ...
        <tr>
          <td style="border: 1px solid #ccc; width:140px; height:113px; text-align:center;"><a href="/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo];?>&id1=<?=$arrprods[$i][fatherid];?>&id2=<?=$arrprods[$i][id_proddir];?>"><img src="/upload/product/<?=$arronepic[pic];?>" border="0" /></a></td>
        </tr>
      </table>
              </div>        
                   <?php }?>
  ...
  <tr>
    <td height="35" style="border:1px solid #DDDDDD; border-top:0px none; background:url(inc/pics/v_bg.jpg) repeat-x left bottom;"><img src="inc/pics/right_bt3.gif" width="216" height="35" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
      <td width="216" height="35" style="border:1px solid #DDDDDD; border-top:0px none; background:url(inc/pics/v_bg.jpg) repeat-x left bottom;"><img src="inc/pics/right_bt2.gif"  width="216" height="35" /></td>
    </tr>
