...
//新闻
$strSQL = "select a.title,a.id_newsinfo,a.id_newsdir from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.lang=0  and a.id_newsdir not in(27,28)  order by a.id_newsinfo desc limit 6" ;
$objDB->Execute($strSQL);
