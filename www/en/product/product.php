    ...
    <td width="773" valign="top"><table width="733" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:19px;">
        <tr>
          <td width="733" style="background:url(../../inc/pics/bg1.gif) repeat-x left bottom;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" align="right" style="color:#999999"><img src="../../inc/pics/arr6.gif" width="9" height="9" align="absmiddle" />&nbsp;Location：<a href="/" class="agray">Home</a> - <a href="/product/product.php" class="agray">Product</a> - <?=$aboutus[title];?></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <table width="150" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 22px">
            <tr>
              <td width="150" align="center" style="padding:2px; border:1px solid #C6C6C6"><a href="/en/product/productinfo.php?pid=<?=$arrprods[$i][id_prodinfo];?>&id1=<?=$arrprods[$i][fatherid];?>&id2=<?=$arrprods[$i][id_proddir];?>" ><img src="/upload/product/<?=$arronepic[pic];?>" border="0" /></a></td>
            </tr>
            <tr>
            ...
            <tr>
              <td bgcolor="#EFEFEF" style="padding:4px 7px 4px 7px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="19" align="left">Date：<?=substr($arrprods[$i][indate],0,10);?><span style="font-size: 11px"></span>&nbsp;&nbsp;<a href="#" target="_blank" title="放大图片"><img src="/inc/pics/zoom.gif" border="0" align="absmiddle" /></a></td>
                </tr>
              </table></td>
            </tr>
          </table>
