...
<table width="940" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:1px; background:url(../inc/pics/main_bg.jpg) repeat-x;">
    ...
    <td width="773" valign="top"><table width="733" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:19px;">
        <tr>
          <td width="733" style="background:url(../inc/pics/bg1.gif) repeat-x left bottom;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" align="right" style="color:#999999"><img src="../inc/pics/arr6.gif" width="9" height="9" align="absmiddle" />&nbsp;当前位置：<a href="/" class="agray">首页</a> - <a href="/hr/hr.php" class="agray">人力资源</a> - <?=$newsdirnavi[name];?></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><table width="733" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="673" align="left" background="../inc/pics/title_bg_center.jpg" style="color:#000000; font-size:14px; font-weight:bold">人力资源</td>
  ...
  <tr height="28">
    <td width="624" align="left" style="background:url(../inc/pics/bg2.gif) repeat-x left bottom;">&nbsp;<img src="../inc/pics/arr.gif" width="11" height="14" align="absmiddle" />&nbsp;&nbsp;<a href="/hr/hrpage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>&ndir=<?=$arrnews[$i][id_newsdir];?>"><?=$arrnews[$i][title];?></a></td>
